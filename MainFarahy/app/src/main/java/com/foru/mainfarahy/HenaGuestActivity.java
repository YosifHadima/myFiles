...
public class HenaGuestActivity extends AppCompatActivity {
    ListView listView;
...
// Request an ad
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDb=new DataBaseGuestHenaHelper (this);
...
//in case of click add new member button
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(HenaGuestActivity.this);
